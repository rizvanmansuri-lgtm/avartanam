...
/* ═══ Mobile Nav Extra Fixes ══════════════════════════════
   Auto-close on tap, overlay backdrop, arrow animation
══════════════════════════════════════════════════════════ */
(function() {
  function initNavFixes() {
    var overlay = document.getElementById('atlNavOverlay');
    if (!overlay) {
      overlay = document.createElement('div');
      overlay.id = 'atlNavOverlay';
      overlay.className = 'atl-nav-overlay';
    ...
    // Re-wire burger to use open/close with overlay
    if (burger && mobileNav) {
    ...
    // Auto-close when a nav link inside mobile drawer is tapped
    if (mobileNav) {
      mobileNav.querySelectorAll('a[href]').forEach(function(link) {
        link.addEventListener('click', function() {
          // Only close if it's a real page link (not # or javascript:)
