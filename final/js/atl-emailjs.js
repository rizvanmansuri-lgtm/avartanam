...
(function () {
  ...
  var EMAILJS_PUBLIC_KEY    = 'abc123XYZ';       // e.g. 'abc123XYZ'
  var EMAILJS_SERVICE_ID    = 'service_avartanam';       // e.g. 'service_avartanam'
  var EMAILJS_TEMPLATE_CONTACT  = 'template_Contact';   // Contact form template
  var EMAILJS_TEMPLATE_QUOTE    = 'template_Quote';     // Quote/request form template
  var EMAILJS_TEMPLATE_BROCHURE = 'template_Brochure';  // Brochure download template
  var EMAILJS_TEMPLATE_BUY      = 'template_Buy';       // Buy/product inquiry template
  /* ─────────────────────────────────────────────────────── */
