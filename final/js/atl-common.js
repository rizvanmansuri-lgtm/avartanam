...
(function () {
  ...
  function injectWAButton() {
    if (document.getElementById('atlWABtn')) return;
    var a = document.createElement('a');
    a.id        = 'atlWABtn';
    a.className = 'atl-wa-btn';
    ...
    a.innerHTML =
      '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">' +
        ...
        '<path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.558 4.116 1.535 5.845L.057 23.213' +
        'a.75.75 0 00.92.92l5.368-1.478A11.955 11.955 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0z' +
        'M12 22a9.956 9.956 0 01-5.187-1.449l-.372-.22-3.853 1.061 1.061-3.853-.22-.372A9.956 9.956 0 012 12' +
        'C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>' +
      '</svg>' +
      '<span class="atl-wa-btn__label">Chat with us</span>';

    document.body.appendChild(a);
  }

  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', injectWAButton);
  } else {
    injectWAButton();
  }
})();
